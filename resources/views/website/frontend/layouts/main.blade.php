                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div class="single-new-pro mb-30 text-center">
                            <div class="product-img">
                                <img src="{{asset($artc->imagen)}}" alt="">
                            </div>
                            <div class="product-caption">
                            <h3><a href="product_details.html">{{$artc->nombre_articulo}}</a></h3>
                            <span>$ {{$artc->precio}}</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div class="single-popular-items mb-50 text-center">
                            <div class="popular-img">
                                ...
                                <img src="{{asset($pop->imagen)}}" height="100px" width="100px">
                                <div class="img-cap">
                            ...
                            <h3><a href="{{route('website.addCart',$pop->id)}}">{{$pop->nombre_articulo}}</a></h3>
                                <span>$ {{$pop->precio}}</span>
                            </div>
                        </div>
                    </div>
